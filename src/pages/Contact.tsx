                ...
                <div className="space-y-6">
                  <div className="bg-[#1B2A4A] rounded-2xl p-6 sm:p-8 text-white">
                    ...
                    <div className="space-y-5">
                      <div className="flex items-start gap-4"><MapPin className="w-5 h-5 text-[#16A34A] mt-0.5 flex-shrink-0" /><div><p className="text-[14px] font-medium mb-0.5">Udaan24 AI Institute</p><p className="text-[13px] text-white/60">Batian wala Chownk, Jaitu Road, opposite Car Parking,<br />Above Punjab &amp; Sind Bank, Kotkapura</p></div></div>
                      ...
                      <div className="flex items-start gap-4"><Mail className="w-5 h-5 text-[#16A34A] mt-0.5 flex-shrink-0" /><div><p className="text-[14px] font-medium mb-0.5">Email</p><p className="text-[13px] text-white/60">info@udaan24.com</p></div></div>
